    ...
    return (
        <>
            <header className='z-[999] relative'>
                ...
                w-full rounded-none border border-white border-opacity-80
                bg-white bg-opacity-80 shadow-lg shadow-black/[0.03]
                backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[36rem] 
                sm:rounded-full dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-60'
                ...
                py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0'>
                    ...
                    font-medium sm:w-[initial] sm:flex-nowrap sm:gap-5'>
                        {links.map((link) => (
                            <motion.li className='h-3/4 relative flex items-center justify-center' key={link.hash}
                                initial={{ y: -100, opacity: 0 }}
                                animate={{ y: 0, opacity: 1 }}>
                                <Link
                                    className={`flex w-full items-center justify-center
                                        px-3 py-3 hover:text-gray-950 transition-all dark:text-white dark:hover:text-gray-300
                                    ...
                                    {activeSection === link.name && (
                                        ...
                                        inset-0 absolute -z-10 p-0 dark:bg-gray-700'
